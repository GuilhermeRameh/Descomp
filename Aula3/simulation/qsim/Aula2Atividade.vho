...
SIGNAL \decoderInstru|saida[1]~1_combout\ : std_logic;
SIGNAL \decoderInstru|saida[2]~2_combout\ : std_logic;
...
SIGNAL \decoderInstru|saida[0]~0_combout\ : std_logic;
...
SIGNAL \decoderInstru|ALT_INV_saida[1]~1_combout\ : std_logic;
...
\decoderInstru|ALT_INV_saida[1]~1_combout\ <= NOT \decoderInstru|saida[1]~1_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \decoderInstru|saida[0]~0_combout\,
	devoe => ww_devoe,
	o => ww_LEDR(6));
...
-- pragma translate_on
PORT MAP (
	i => \decoderInstru|saida[1]~1_combout\,
	devoe => ww_devoe,
	o => ww_LEDR(7));
...
-- pragma translate_on
PORT MAP (
	i => \decoderInstru|saida[2]~2_combout\,
	devoe => ww_devoe,
	o => ww_LEDR(8));
...
\decoderInstru|saida[1]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \decoderInstru|saida[1]~1_combout\ = ( !\PC|DOUT\(2) & ( !\PC|DOUT\(1) & ( !\PC|DOUT[0]~DUPLICATE_q\ ) ) )
...
PORT MAP (
	...
	combout => \decoderInstru|saida[1]~1_combout\);

-- Location: LABCELL_X6_Y16_N54
\decoderInstru|saida[2]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \decoderInstru|saida[2]~2_combout\ = ( !\PC|DOUT\(2) & ( \PC|DOUT[0]~DUPLICATE_q\ ) ) # ( \PC|DOUT\(2) & ( !\PC|DOUT[0]~DUPLICATE_q\ & ( !\PC|DOUT\(1) ) ) ) # ( !\PC|DOUT\(2) & ( !\PC|DOUT[0]~DUPLICATE_q\ & ( \PC|DOUT\(1) ) ) )
...
PORT MAP (
	...
	datae => \PC|ALT_INV_DOUT\(2),
	dataf => \PC|ALT_INV_DOUT[0]~DUPLICATE_q\,
	combout => \decoderInstru|saida[2]~2_combout\);
...
PORT MAP (
	...
	clrn => \decoderInstru|ALT_INV_saida[1]~1_combout\,
	ena => \decoderInstru|saida[2]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \REGA|DOUT\(0));
...
\decoderInstru|saida[0]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \decoderInstru|saida[0]~0_combout\ = ( \PC|DOUT[1]~DUPLICATE_q\ & ( !\PC|DOUT[2]~DUPLICATE_q\ ) ) # ( !\PC|DOUT[1]~DUPLICATE_q\ & ( (\PC|DOUT\(0) & !\PC|DOUT[2]~DUPLICATE_q\) ) )
...
PORT MAP (
	...
	dataf => \PC|ALT_INV_DOUT[1]~DUPLICATE_q\,
	combout => \decoderInstru|saida[0]~0_combout\);
